...
,case when ( instr(bao.partner_insurance_name,'云南信托')>0 or instr(bao.partner_insurance_name,'湖南信托-主动管理')>0) then
...
,interview_time
from (select * from tmp_record where sendloancommand_remark='同意' and sendloancommand_time>='${var:logdate}')  t666
