...
drop table if exists ods.tmp_ods_rcs_icrloancardinfo_latest24state_split;
create table if not exists ods.tmp_ods_rcs_icrloancardinfo_latest24state_split (
...
insert overwrite table ods.`tmp_ods_rcs_icrloancardinfo_latest24state_split`
select 
reportno
, serialno
, latest24state
...
, 1 latest24state_no
from ods.ods_rcs_icrloancardinfo where latest24state <> "" and latest24state is not null 
