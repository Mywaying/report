...
drop table if exists dws.tmp_report_revenue_part_two_add_x;
create table if not exists dws.tmp_report_revenue_part_two_add_x (
...
tmp_lrfy as (
    ...
    group by a.qdjl_name, a.sctd_name, a.company_name, a.product_name, a.product_type, a.product_name_c, a.is_overtime, a.create_date
)

insert overwrite table dws.tmp_report_revenue_part_two_add_x
select
a.create_date, a.company_name, a.qdjl_name, a.sctd_name, a.product_name, a.product_type, a.product_name_c, a.is_overtime
...
from
    ...
    left join tmp_biz_fee_detial tbfd on a.apply_no = tbfd.apply_no
          ...
          left join tmp_t as zta on a.company_name = zta.company_name
                  and a.qdjl_name = zta.qdjl_name
                  and a.sctd_name = zta.sctd_name
    ...
    left join (
        ...
        ,a.is_overtime
            ...
            and a.qdjl_name = b.qdjl_name
            and a.sctd_name = b.sctd_name
