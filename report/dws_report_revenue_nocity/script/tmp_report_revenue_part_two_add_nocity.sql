...
drop table if exists dws.tmp_report_revenue_part_two_add_nocity;
create table if not exists dws.tmp_report_revenue_part_two_add_nocity (
...
tmp_lrfy as (
    ...
    group by a.product_name, a.product_type, a.product_name_c, a.is_overtime, a.create_date
)

insert overwrite table dws.tmp_report_revenue_part_two_add_nocity
select
a.create_date, a.product_name, a.product_type, a.product_name_c, a.is_overtime
...
from
    ...
    left join tmp_biz_fee_detial tbfd on a.apply_no = tbfd.apply_no
          ...
          left join tmp_t as zta on a.product_name = zta.product_name
    ...
    left join (
        ...
        ,a.create_date
        ,a.is_overtime
    ) as b on a.product_name = b.product_name
